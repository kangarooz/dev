...
1. Run `python -m demo_smoke voice-check --ref $1 --out demo-output/voice-check --tts auto` (the first run loads the model and can take a minute; set the bash tool `timeout` to 600000 ms) and wait for it to finish.
